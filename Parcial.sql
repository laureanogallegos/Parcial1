...
------------------------MEDICAMENTOS---------------------------------------------------------
CREATE TABLE MEDICAMENTOS (ID INT NOT NULL PRIMARY KEY IDENTITY, 
NOMBRE_COMERCIAL NVARCHAR(50) NOT NULL UNIQUE, 
ES_VENTA_LIBRE BIT NOT NULL, 
PRECIO_VENTA DECIMAL NOT NULL, 
STOCK INT NOT NULL, 
STOCK_MINIMO INT NOT NULL, 
ID_MONODROGRA INT NOT NULL FOREIGN KEY REFERENCES MONODROGAS(ID))
GO
